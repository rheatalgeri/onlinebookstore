            ...
            <body>
                ...
                <div class="container">
                    ...
                    <div class="response-message"
                        style="display: none; color: green; text-align: center; margin-bottom: 20px;"></div>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>ID</th>
                        ...
                        <tbody>
                            <c:forEach var="book" items="${booklist}">
                                ...
                                <tr>
                                    ...
                                    <td>${book.bookId}</td>
                                    <td><a href="${pageContext.request.contextPath}/viewbook?bookId=${book.bookId}"
                                    ...
                                    <td>
                                        <form class="add-to-cart-form"
                                            action="${pageContext.request.contextPath}/addtocart" method="post">
